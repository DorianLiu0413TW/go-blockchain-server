...
func HTTPJSONRequest(method, url string, requestBody interface{}, headers map[string]string) (response []byte, err error) {
...
func HTTPRequest(method, url string, buffer io.Reader, headers map[string]string) (response []byte, err error) {
